    ...
    */
    ...
    public static async createTheme(options) {
        ...
        try {
            ...
            // Logger.info(`Token Data: ${JSON.stringify(configObj)}`);
            ...
            //     );
            // }
            // Logger.info(`Token expires in: ${configObj.expires_in}`);
            const appConfig = {
                _id: 'kjskfjas',
            ...
            const theme = {_id:'one'}//await ThemeService.createTheme({ ...configObj, ...themeData });
